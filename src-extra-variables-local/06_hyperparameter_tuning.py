...
drop_cols_a = [
    'Gold_Close', 'Silver_Close', 'DXY_Close', 'EGP_USD_Close', 'Local_Gold_24k_EGP',
...
y = train_val_data['Local_Gold_24k_EGP_LogReturn']
...
# --- 7. SAVE TO FILE ---
output_path = '../data-extra-variables-local/best_xgboost_gold_params.txt'
with open(output_path, 'w') as f:
    f.write("Best Hyperparameters for Local Gold Architecture A (Differencing + Extras):\n")
    for param, value in best_params.items():
