...
drop_cols_a = ['Gold_Close', 'Silver_Close', 'DXY_Close', 'EGP_USD_Close', 'Gold_Close_LogReturn', 'Silver_Close_LogReturn', 'DXY_Close_LogReturn', 'EGP_USD_Close_LogReturn']
X_test_a = test_a.drop(columns=drop_cols_a)

drop_cols_b = ['Gold_Close', 'Silver_Close', 'DXY_Close', 'EGP_USD_Close', 'Gold_Close_Trend', 'Gold_Close_Residual', 'Silver_Close_Trend', 'Silver_Close_Residual', 'DXY_Close_Trend', 'DXY_Close_Residual', 'EGP_USD_Close_Trend', 'EGP_USD_Close_Residual']
