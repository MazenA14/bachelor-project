...
#   Models loaded from  : ../models-energy/  (xgboost_a.json, xgboost_b.json, arima_baseline.pkl)
...
print("Initiating Phase 4: Model Evaluation Protocol (Energy, No ARIMA Recalculation)...\n")
...
yesterday_price_a.iloc[0] = df_master.loc[last_val_date, 'Brent_Crude_Close']
...
plt.title('Brent Crude Forecast: Baseline vs. XGBoost Architectures (Test Set)', fontsize=16)
