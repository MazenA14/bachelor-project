...
print("Initiating Phase 4: Model Evaluation (No Extras, Energy, With ARIMA Recalculation)...\n")
...
plt.title('Brent Crude Forecast: No Extras - 1-Day Rolling Horizon (Test Set)', fontsize=16)
