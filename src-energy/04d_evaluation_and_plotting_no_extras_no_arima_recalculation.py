...
#   Models loaded from  : ../models-energy/  (xgboost_a_no_extras.json, xgboost_b_no_extras.json,
...
print("Initiating Phase 4: Model Evaluation (No Extras, Energy, No ARIMA Recalculation)...\n")
...
plt.title('Brent Crude Forecast: No Extras - Baseline vs. XGBoost (Test Set)', fontsize=16)
