...
print("Initiating Phase 5: Ablation Study (Energy - No Extras)...\n")
...
# (energy: Brent + NatGas, AND macro: DXY, VIX, SP500, US_10Yr)
...
plt.title('Ablation Study: Impact of Local Egyptian Data on Brent Forecast (No Extras)', fontsize=13)
...
plt.title('Brent Crude Forecast: Global Only vs Hybrid (No Extras)', fontsize=16)
