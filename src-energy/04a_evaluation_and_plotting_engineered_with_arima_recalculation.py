...
print("Initiating Phase 4: Model Evaluation — Brent Crude Oil (With ARIMA Walk-Forward Recalculation)...\n")
...
actual_prices    = df_master.loc[test_a_full.index, 'Brent_Crude_Close']
last_train_price = df_master.loc[TRAIN_VAL_END, 'Brent_Crude_Close']
