...
print("Initiating Phase 4: Model Evaluation — Natural Gas (No Extras, Saved ARIMA, No Recalculation)...\n")
...
arima_fitted  = ARIMAResults.load(os.path.join(MODELS_DIR, 'arima_baseline_no_extras_gas.pkl'))
...
last_train_price = df_master.loc[last_val_date, 'Natural_Gas_Close']
