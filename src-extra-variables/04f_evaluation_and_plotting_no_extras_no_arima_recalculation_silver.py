...
print("Initiating Phase 4: Model Evaluation — Silver (No Extras, Saved ARIMA, No Recalculation)...\n")
...
arima_fitted  = ARIMAResults.load(os.path.join(MODELS_DIR, 'arima_baseline_no_extras_silver.pkl'))
...
last_train_price = df_master.loc[last_val_date, 'Silver_Close']
