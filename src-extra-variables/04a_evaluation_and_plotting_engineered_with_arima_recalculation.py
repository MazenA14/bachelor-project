...
print("Initiating Phase 4: Model Evaluation (With ARIMA Walk-Forward Recalculation)...\n")
...
actual_prices    = df_master.loc[test_a_full.index, 'Gold_Close']
last_train_price = df_master.loc[TRAIN_VAL_END, 'Gold_Close']
