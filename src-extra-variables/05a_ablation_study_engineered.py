...
print("Initiating Phase 5: Ablation Study (Global vs. Hybrid)...\n")
...
potential_leakage = [
    'Gold_Close', 'Silver_Close', 'DXY_Close', 'EGP_USD_Close', 'VIX_Close', 'SP500_Close',
    'Gold_Close_LogReturn', 'Silver_Close_LogReturn', 'DXY_Close_LogReturn', 
    'EGP_USD_Close_LogReturn', 'VIX_Close_LogReturn', 'SP500_Close_LogReturn'
]
...
plt.title('Gold Price Forecast: Testing Feature Isolation', fontsize=16)
