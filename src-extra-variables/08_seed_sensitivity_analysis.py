...
OUTPUT_FILE = '../results-extra-variables/08_seed_sensitivity_results.txt'
...
drop_cols = [
    'Gold_Close', 'Silver_Close', 'DXY_Close', 'SP500_Close', 'VIX_Close', 'EGP_USD_Close',
...
COMMODITIES = [
    {
        'label':     'Gold',
        'target':    'Gold_Close_LogReturn',
        'price_col': 'Gold_Close',
    },
    {
        'label':     'Silver',
        'target':    'Silver_Close_LogReturn',
