...
print("Initiating Phase 4: Model Evaluation (No Extras, Crops, With ARIMA Recalculation)...\n")
...
plt.title('Wheat Forecast: No Extras - 1-Day Rolling Horizon (Test Set)', fontsize=16)
