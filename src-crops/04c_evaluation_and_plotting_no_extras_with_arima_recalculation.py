...
#   Extra Features      : NO EXTRAS focus — all 4 variants compared
...
print("Initiating Phase 4: Model Evaluation — Crops (No Extras, With ARIMA Walk-Forward Recalculation)...\n")
...
history      = list(df_master['Wheat_Close'][:TRAIN_VAL_END])
test_actuals = df_master['Wheat_Close'][TEST_START:]
arima_preds  = []
...
actual_prices    = df_master.loc[test_a_noextra.index, 'Wheat_Close']
last_train_price = df_master.loc[TRAIN_VAL_END, 'Wheat_Close']
...
print("\n=== EVALUATION RESULTS — WHEAT, NO EXTRAS (Test Set: January 2025 – Present) ===")
