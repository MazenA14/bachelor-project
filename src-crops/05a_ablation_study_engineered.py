...
#   Stationarity Method : DIFFERENCING  — reads 01a_engineered_differencing_crops_dataset.csv
...
print("Initiating Phase 5: Ablation Study (Crops - Engineered Features)...\n")
...
ENGINEERED_FILE = os.path.join(ROOT_DIR, '03_final', '01a_engineered_differencing_crops_dataset.csv')
...
# (crops: Wheat lags/rolling + Corn/Sugar + Ratio, AND macro: Brent, DXY)
...
plt.title('Ablation Study: Impact of Local Egyptian Data on Wheat Forecast (Engineered)', fontsize=13)
...
plt.title('Wheat Forecast: Global Only vs Hybrid (Engineered Features)', fontsize=16)
