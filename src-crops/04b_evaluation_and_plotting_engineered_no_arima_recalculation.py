...
#   Models loaded from  : ../models-crops/  (xgboost_a.json, xgboost_b.json, arima_baseline.pkl)
...
print("Initiating Phase 4: Model Evaluation Protocol (Crops, No ARIMA Recalculation)...\n")
...
plt.title('Wheat Forecast: Baseline vs. XGBoost Architectures (Test Set)', fontsize=16)
