...
#   Models loaded from  : ../models-crops/  (xgboost_a.json, xgboost_b.json)
...
print("Initiating Phase 4: Model Evaluation Protocol (Crops)...\n")
...
yesterday_price_a.iloc[0] = df_master.loc[TRAIN_VAL_END, 'Wheat_Close']
...
plt.title('Wheat Forecast: 1-Day Rolling Horizon (Test Set)', fontsize=16)
...
plot_importance(xgb_a, max_num_features=10, importance_type='weight',
                title='Top 10 Drivers of Wheat Prices (XGBoost A)',
