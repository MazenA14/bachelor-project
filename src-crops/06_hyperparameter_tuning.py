# =============================================================================
# PIPELINE IDENTITY
#   Dataset             : NO EXTRAS — reads 01a_differencing_crops_dataset.csv
#   Features Used       : Global Only (Wheat, Corn, Sugar, Brent_Crude, DXY)
...
DATA_FILE = os.path.join(FINAL_DIR, '01a_differencing_crops_dataset.csv')
...
# This tunes only on the global signal (crops + macro).
drop_cols = [
    ...
    'Wheat_Close_LogReturn', 'Corn_Close_LogReturn', 'Sugar_Close_LogReturn',
    'Brent_Crude_Close_LogReturn', 'DXY_Close_LogReturn', 'EGP_USD_Close_LogReturn',
...
y = train_val_data['Wheat_Close_LogReturn']
...
# --- 7. SAVE TO FILE ---
output_path = '../data-crops/best_xgboost_wheat_params.txt'
with open(output_path, 'w') as f:
    f.write("Best Hyperparameters for Wheat Architecture A\n")
