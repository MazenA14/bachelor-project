...
OUTPUT_FILE = '../results-crops/08_seed_sensitivity_results.txt'
...
# Columns always dropped regardless of target (raw prices + Egyptian macro variables)
BASE_DROP_COLS = [
...
for commodity in COMMODITIES:
    ...
    # Each commodity drops its own log return to prevent leakage
    drop_cols = BASE_DROP_COLS + [target]
