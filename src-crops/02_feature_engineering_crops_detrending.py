...
#   Output dataset      : 01b_engineered_detrending_crops_dataset.csv
...
output_file = os.path.join(FINAL_DIR, '01b_engineered_detrending_crops_dataset.csv')
...
# Detrend price-based columns; Egypt_Inflation_YoY and CBE_Interest_Rate are already rates and are left as-is
columns_to_detrend = ['Wheat_Close', 'Corn_Close', 'Sugar_Close', 'Brent_Crude_Close', 'DXY_Close', 'EGP_USD_Close']
